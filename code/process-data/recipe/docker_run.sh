docker run \
    ...
    -e BUCKET_NAME=prd-signal-bucket \
    -e TABLE_NAME=sensor-table-prd \
    -e TIMESTREAM_DATABASE_NAME=health-monitor-exp \
    -e TIMESTREAM_TABLE_NAME=plensor-health \
    ...
    --rm 106005884410.dkr.ecr.eu-west-1.amazonaws.com/ggrepository:process-data-004
