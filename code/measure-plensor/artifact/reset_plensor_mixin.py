...
class ResetPlensorMixin:
    """
    Mixin class for reset commands to be inherited by the Sensor
    object classes.
    """
    def reset_plensor(self) -> bool:
        """
        Sends a message to the sensor to reset it.
        """
        try:
            command_byte = [0x62]
